...
void Window::setupCaptionButtons() {
    ...
    auto createCaptionButton = [this](const QString& objectName,
        ...
        auto* button = new view::basicinput::Button(m_captionButtonHost);
        button->setObjectName(objectName);
        button->setToolTip(tooltip);
        button->setFluentStyle(view::basicinput::Button::Subtle);
    ...
    if (auto* anchorLayout = qobject_cast<view::AnchorLayout*>(m_titleBar->layout())) {
        view::AnchorLayout::Anchors anchors;
        anchors.right = {m_titleBar, view::AnchorLayout::Edge::Right, 0};
        anchors.verticalCenter = {m_titleBar, view::AnchorLayout::Edge::VCenter, 0};
