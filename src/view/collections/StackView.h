...
Q_DECLARE_METATYPE(view::collections::StackView::StackViewItemStatus)
Q_DECLARE_METATYPE(view::collections::StackView::StackViewTransitionOperation)
Q_DECLARE_METATYPE(view::collections::StackView::StackViewTransitionType)
Q_DECLARE_METATYPE(view::collections::StackView::StackViewItemOwnership)
