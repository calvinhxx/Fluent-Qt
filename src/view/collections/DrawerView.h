...
Q_DECLARE_OPERATORS_FOR_FLAGS(view::collections::DrawerView::ClosePolicy)
Q_DECLARE_METATYPE(view::collections::DrawerView::DrawerEdge)
Q_DECLARE_METATYPE(view::collections::DrawerView::ClosePolicy)
