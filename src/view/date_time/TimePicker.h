 ...
 * 选中值和下拉状态，用于时间输入流程。
 */
class TimePicker : public view::basicinput::Button {
    Q_OBJECT
    /**
...
Q_DECLARE_METATYPE(view::date_time::TimePicker::TimeField)
Q_DECLARE_METATYPE(view::date_time::TimePicker::ClockIdentifier)
