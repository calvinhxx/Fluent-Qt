...
class TimePickerFlyout : public view::dialogs_flyouts::Flyout {
public:
...
private:
    ...
    view::basicinput::Button* m_confirmButton = nullptr;
    view::basicinput::Button* m_cancelButton = nullptr;
};
    ...
    , m_flyout(flyout)
{
    ...
    m_confirmButton = new view::basicinput::Button(this);
    m_confirmButton->setObjectName(QStringLiteral("TimePickerConfirmButton"));
    m_confirmButton->setFluentStyle(view::basicinput::Button::Subtle);
    m_confirmButton->setFluentLayout(view::basicinput::Button::IconOnly);
    ...
    m_cancelButton = new view::basicinput::Button(this);
    m_cancelButton->setObjectName(QStringLiteral("TimePickerCancelButton"));
    m_cancelButton->setFluentStyle(view::basicinput::Button::Subtle);
    m_cancelButton->setFluentLayout(view::basicinput::Button::IconOnly);
    ...
    connect(m_confirmButton, &view::basicinput::Button::clicked, this, [this] {
        if (m_flyout)
            m_flyout->commit();
    });
    connect(m_cancelButton, &view::basicinput::Button::clicked, this, [this] {
        if (m_flyout)
            m_flyout->cancel();
    });
}
...
TimePickerFlyout::TimePickerFlyout(TimePicker* owner)
    : view::dialogs_flyouts::Flyout(owner)
    , m_owner(owner)
{
...
{
    view::dialogs_flyouts::Flyout::onThemeUpdated();
    if (m_panel)
...
void TimePickerFlyout::keyPressEvent(QKeyEvent* event)
{
    ...
    view::dialogs_flyouts::Flyout::keyPressEvent(event);
}
    ...
    : view::basicinput::Button(parent)
{
    ...
    connect(this, &view::basicinput::Button::clicked, this, &TimePicker::openPicker);
    onThemeUpdated();
}
