...
private:
    ...
    struct TabHeaderWidgets {
        int tabIndex = -1;
        fluent::textfields::Label* label = nullptr;
        fluent::basicinput::Button* closeButton = nullptr;
    ...
    fluent::basicinput::Button* createIconButton(const QString& glyph, int pixelSize);
    void updateIconButton(fluent::basicinput::Button* button, const QRect& rect, const QString& glyph, int pixelSize, bool enabled);
    ...
    fluent::basicinput::Button* m_addButton = nullptr;
    fluent::basicinput::Button* m_overflowBackButton = nullptr;
    fluent::basicinput::Button* m_overflowForwardButton = nullptr;
};
...
Q_DECLARE_METATYPE(fluent::navigation::TabViewItem)
Q_DECLARE_METATYPE(fluent::navigation::TabView::TabWidthMode)
Q_DECLARE_METATYPE(fluent::navigation::TabView::CloseButtonOverlayMode)
