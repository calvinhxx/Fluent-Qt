...
Q_DECLARE_METATYPE(fluent::navigation::BreadcrumbItem)
Q_DECLARE_METATYPE(fluent::navigation::Breadcrumb::BreadcrumbSize)
Q_DECLARE_METATYPE(fluent::navigation::Breadcrumb::OverflowMode)
