...
#include "view/collections/StackView.h"
#include "view/scrolling/PipsPager.h"

using view::collections::StackView;
using view::scrolling::PipsPager;

namespace {

using Edge = view::AnchorLayout::Edge;

class StackViewTestWindow : public QWidget, public FluentElement {
public:
...
protected:
    ...
    {
        qRegisterMetaType<StackView::StackViewItemStatus>("view::collections::StackView::StackViewItemStatus");
        qRegisterMetaType<StackView::StackViewTransitionOperation>("view::collections::StackView::StackViewTransitionOperation");
        qRegisterMetaType<StackView::StackViewTransitionType>("view::collections::StackView::StackViewTransitionType");
        qRegisterMetaType<StackView::StackViewItemOwnership>("view::collections::StackView::StackViewItemOwnership");
...
TEST_F(StackViewTest, DefaultsExposeExpectedApi)
{
    ...
    EXPECT_NE(dynamic_cast<FluentElement*>(&stack), nullptr);
    EXPECT_NE(dynamic_cast<view::QMLPlus*>(&stack), nullptr);
}
...
TEST_F(StackViewTest, VisualCheck)
{
    ...
    auto* rootLayout = new view::AnchorLayout();
    ...
    auto* controlsLayout = new view::AnchorLayout();
    ...
    view::AnchorLayout::Anchors orientationAnchors;
    ...
    view::AnchorLayout::Anchors pagerAnchors;
    ...
    view::AnchorLayout::Anchors stackAnchors;
    ...
    view::AnchorLayout::Anchors pushAnchors;
    ...
    view::AnchorLayout::Anchors popAnchors;
    ...
    view::AnchorLayout::Anchors replaceAnchors;
