...
using view::collections::FlipView;
using view::scrolling::PipsPager;

namespace {

class PipsPagerTestWindow : public QWidget, public FluentElement {
public:
...
protected:
    ...
    {
        qRegisterMetaType<PipsPager::PipsPagerButtonVisibility>(
        "view::scrolling::PipsPager::PipsPagerButtonVisibility");
