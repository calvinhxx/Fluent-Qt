...
#include "view/scrolling/AnnotatedScrollBar.h"
#include "view/scrolling/ScrollView.h"
#include "view/textfields/Label.h"

using view::AnchorLayout;
using view::basicinput::Button;
using view::basicinput::Slider;
using view::scrolling::AnnotatedScrollBar;
using view::scrolling::AnnotatedScrollBarLabel;
...
class ColorSectionsContent : public QWidget, public FluentElement {
public:
...
protected:
    void paintEvent(QPaintEvent*) override
    {
        ...
        for (int section = 0; section < colors.size(); ++section) {
            ...
            fill.setAlphaF(currentTheme() == FluentElement::Dark ? 0.68 : 0.84);
...
class AnnotatedScrollBarVisualWindow : public QWidget, public FluentElement {
public:
...
class VisualPanel : public QWidget, public FluentElement {
public:
    using QWidget::QWidget;
...
TEST_F(AnnotatedScrollBarTest, DefaultsExposeExpectedApi)
{
    ...
    EXPECT_NE(dynamic_cast<FluentElement*>(&bar), nullptr);
    EXPECT_NE(dynamic_cast<view::QMLPlus*>(&bar), nullptr);
}
