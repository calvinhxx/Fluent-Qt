...
using view::scrolling::ScrollBar;
using view::scrolling::ScrollView;
using view::scrolling::ScrollViewZoomAware;
using view::textfields::Label;

namespace {

class ScrollViewTestWindow : public QWidget, public FluentElement {
public:
...
class DemoCanvas : public QWidget, public FluentElement, public ScrollViewZoomAware {
public:
...
protected:
    void paintEvent(QPaintEvent*) override {
        ...
        for (int index = 0; index < 18; ++index) {
            ...
            fill.setAlphaF(currentTheme() == FluentElement::Dark ? 0.72 : 0.88);
