...
view::status_info::ToolTip* elideToolTip(Label* label) {
    return label->findChild<view::status_info::ToolTip*>(
...
TEST_F(LabelTest, VisualCheck) {
    ...
    createElideRow("ElideMiddle",
                   "/Users/calvinhxx/Ws/qttest/Fluent-QT/src/view/textfields/Label.cpp",
                   Qt::ElideMiddle,
                   260,
                   rightElide);
