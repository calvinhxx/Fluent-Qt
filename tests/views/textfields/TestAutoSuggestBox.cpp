...
protected:
    static void SetUpTestSuite()
    {
        ...
        qRegisterMetaType<AutoSuggestBox::QueryButtonPlacement>("AutoSuggestBox::QueryButtonPlacement");
    }
...
TEST_F(AutoSuggestBoxTest, MouseClickSuggestionChoosesAndSubmits) {
    ...
    auto* popup = window->findChild<view::dialogs_flyouts::Flyout*>("AutoSuggestBoxSuggestionPopup");
    ASSERT_NE(popup, nullptr);
