...
#include "view/date_time/CalendarDatePicker.h"
...
using view::date_time::CalendarDatePicker;
...
class CalendarDatePickerTestWindow : public QWidget, public FluentElement {
public:
