...
class DatePickerTestWindow : public QWidget, public FluentElement {
public:
...
protected:
    static void SetUpTestSuite()
    {
        ...
        qRegisterMetaType<DatePicker::DateField>("DatePicker::DateField");
        qRegisterMetaType<DatePicker::MonthFormat>("DatePicker::MonthFormat");
        qRegisterMetaType<DatePicker::DayFormat>("DatePicker::DayFormat");
        qRegisterMetaType<DatePicker::YearFormat>("DatePicker::YearFormat");
    }
