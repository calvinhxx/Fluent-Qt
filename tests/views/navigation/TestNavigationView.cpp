...
#include "view/navigation/NavigationView.h"
...
using view::navigation::NavigationView;
using view::navigation::StackContentHost;
using view::textfields::Label;

namespace {

class NavigationViewTestWindow : public QWidget, public FluentElement {
public:
...
class NavigationItemRow : public QWidget, public FluentElement {
public:
...
class NavigationPaneSection : public QWidget, public FluentElement {
public:
    struct Entry {
        QString icon;
        QString text;
...
class DashboardPage : public QWidget, public FluentElement {
public:
...
protected:
    ...
    {
        qRegisterMetaType<NavigationView::DisplayMode>("view::navigation::NavigationView::DisplayMode");
        qRegisterMetaType<StackContentHost::TransitionEffect>("view::navigation::StackContentHost::TransitionEffect");
    }
...
TEST_F(NavigationViewTest, DefaultsAndPropertiesMatchShellContainer)
{
    ...
    EXPECT_NE(dynamic_cast<FluentElement*>(&nav), nullptr);
    EXPECT_NE(dynamic_cast<view::QMLPlus*>(&nav), nullptr);
...
TEST_F(NavigationViewTest, VisualCheck)
{
    ...
    QObject::connect(themeButton, &Button::clicked, [visual, nav, themeButton, sideHeader, sideMain, sideFooter, pages]() {
        const bool useDark = FluentElement::currentTheme() == FluentElement::Light;
        FluentElement::setTheme(useDark ? FluentElement::Dark : FluentElement::Light);
        visual->onThemeUpdated();
        nav->onThemeUpdated();
