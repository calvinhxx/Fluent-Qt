...
#include "view/navigation/Breadcrumb.h"
...
using view::navigation::Breadcrumb;
using view::navigation::BreadcrumbItem;
using view::navigation::StackContentHost;
using view::textfields::Label;

namespace {

class BreadcrumbTestWindow : public QWidget, public FluentElement {
public:
...
class BreadcrumbContentPanel : public QWidget, public FluentElement, public view::QMLPlus {
public:
...
protected:
    ...
    {
        qRegisterMetaType<BreadcrumbItem>("view::navigation::BreadcrumbItem");
        qRegisterMetaType<QVector<int>>("QVector<int>");
        qRegisterMetaType<Breadcrumb::BreadcrumbSize>("view::navigation::Breadcrumb::BreadcrumbSize");
        qRegisterMetaType<Breadcrumb::OverflowMode>("view::navigation::Breadcrumb::OverflowMode");
    }
...
TEST_F(BreadcrumbTest, DefaultsAndInheritanceMatchComponentPattern)
{
    ...
    EXPECT_NE(dynamic_cast<FluentElement*>(&breadcrumb), nullptr);
    EXPECT_NE(dynamic_cast<view::QMLPlus*>(&breadcrumb), nullptr);
}
