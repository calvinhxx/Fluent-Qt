...
#include "view/navigation/SelectorBar.h"
...
using view::navigation::SelectorBar;
using view::navigation::SelectorBarItem;
using view::navigation::StackContentHost;
using view::textfields::Label;

namespace {

class SelectorBarTestWindow : public QWidget, public FluentElement {
public:
...
protected:
    ...
    {
        qRegisterMetaType<SelectorBarItem>("view::navigation::SelectorBarItem");
        qRegisterMetaType<SelectorBar::OverflowBehavior>("view::navigation::SelectorBar::OverflowBehavior");
...
TEST_F(SelectorBarTest, DefaultsInheritanceAndMetatypesMatchComponentPattern)
{
    ...
    EXPECT_NE(dynamic_cast<FluentElement*>(&selector), nullptr);
    EXPECT_NE(dynamic_cast<view::QMLPlus*>(&selector), nullptr);
