...
#include "view/navigation/TabView.h"
#include "view/scrolling/ScrollView.h"
#include "view/textfields/Label.h"

using view::AnchorLayout;
using view::basicinput::Button;
using view::navigation::StackContentHost;
using view::navigation::TabView;
using view::navigation::TabViewItem;
using view::scrolling::ScrollView;
using view::textfields::Label;

namespace {

class TabViewTestWindow : public QWidget, public FluentElement {
public:
...
protected:
    ...
    {
        qRegisterMetaType<TabViewItem>("view::navigation::TabViewItem");
        qRegisterMetaType<TabView::TabWidthMode>("view::navigation::TabView::TabWidthMode");
        qRegisterMetaType<TabView::CloseButtonOverlayMode>("view::navigation::TabView::CloseButtonOverlayMode");
    }
...
TEST_F(TabViewTest, DefaultsInheritanceAndMetatypesMatchComponentPattern)
{
    ...
    EXPECT_NE(dynamic_cast<FluentElement*>(&tabs), nullptr);
    EXPECT_NE(dynamic_cast<view::QMLPlus*>(&tabs), nullptr);
