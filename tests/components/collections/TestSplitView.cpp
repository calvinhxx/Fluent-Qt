...
class SplitViewTestWindow : public QWidget, public fluent::FluentElement {
public:
...
TEST_F(SplitViewTest, VisualCheck)
{
    ...
    auto* navAnchors = new fluent::AnchorLayout(navPanel);
    ...
    controlsAnchors.left = {navPanel, fluent::AnchorLayout::Edge::Left, 0};
    controlsAnchors.right = {navPanel, fluent::AnchorLayout::Edge::Right, 0};
    controlsAnchors.top = {navPanel, fluent::AnchorLayout::Edge::Top, 0};
    controls->setFixedHeight(34);
    navAnchors->addAnchoredWidget(controls, controlsAnchors);

    fluent::AnchorLayout::Anchors splitAnchors;
    splitAnchors.left = {navPanel, fluent::AnchorLayout::Edge::Left, 0};
    splitAnchors.right = {navPanel, fluent::AnchorLayout::Edge::Right, 0};
    splitAnchors.top = {controls, fluent::AnchorLayout::Edge::Bottom, 10};
    splitAnchors.bottom = {navPanel, fluent::AnchorLayout::Edge::Bottom, 0};
