...
class PivotTestWindow : public QWidget, public fluent::FluentElement {
public:
...
protected:
    ...
    {
        qRegisterMetaType<fluent::navigation::PivotItem>("fluent::navigation::PivotItem");
        qRegisterMetaType<fluent::navigation::Pivot::OverflowBehavior>(
            "fluent::navigation::Pivot::OverflowBehavior");
...
TEST_F(PivotTest, DefaultsInheritanceAndMetatypesMatchComponentPattern)
{
    ...
    EXPECT_NE(dynamic_cast<fluent::FluentElement*>(&pivot), nullptr);
    EXPECT_NE(dynamic_cast<fluent::QMLPlus*>(&pivot), nullptr);
