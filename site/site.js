const translations = {
  zh: {
    ...
    "meta.description": "Fluent-Qt 是面向 Qt Widgets 的 C++17 控件库，并提供可选的 Python / PySide6 兼容层。",
    "a11y.skip": "跳到主要内容",
    "a11y.primaryNav": "主导航",
  ...
  en: {
    ...
    "meta.description": "Fluent-Qt is a C++17 control library for Qt Widgets with optional Python / PySide6 compatibility.",
