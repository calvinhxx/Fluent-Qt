const translations = {
  zh: {
    ...
    "nav.gallery": "Gallery",
    "nav.downloads": "下载",
    "hero.titleLine1": "Qt Widgets 的",
    "hero.titleLine2": "Fluent 控件库",
    "hero.lede": "覆盖基础输入、导航、对话框和窗口组件",
  ...
  en: {
    ...
    "hero.titleLine1": "Fluent controls",
    "hero.titleLine2": "for Qt Widgets",
    "hero.lede": "Input, navigation, dialogs, and windowing",
