const translations = {
  zh: {
    ...
    "quickStart.copy": "支持 FetchContent、add_subdirectory 与 find_package；在 QApplication 前调用 fluent::prepareHighDpiApplication() 后，控件会跟随系统缩放，无需应用级倍率",
  ...
  en: {
    ...
    "quickStart.copy": "Supports FetchContent, add_subdirectory, and find_package; call fluent::prepareHighDpiApplication() before QApplication so controls follow the system scale without an app multiplier",
