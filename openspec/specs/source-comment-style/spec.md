# source-comment-style Specification

## Purpose

Define the project-neutral source comment contract for code under `src/`, including bilingual public API comments, implementation-comment boundaries, reusable terminology, and representative coverage expectations.
