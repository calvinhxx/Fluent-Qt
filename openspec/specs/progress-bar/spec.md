...
规范 `view::status_info::ProgressBar`：提供 Fluent 横向进度条，支持 determinate/indeterminate、range/value、paused/error/disabled 状态、rail/track 尺寸配置、主题刷新和 VisualCheck 示例。
