...
The system SHALL provide `view::date_time::DatePicker` as a Fluent segmented date picker for nullable date entry, range-constrained column selection, and WinUI-style picker flyout composition.
