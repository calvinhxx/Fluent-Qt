...
The system SHALL provide `view::date_time::TimePicker` as a Fluent segmented time picker for nullable time entry, clock-mode formatting, minute-step selection, and WinUI-style picker flyout composition.
