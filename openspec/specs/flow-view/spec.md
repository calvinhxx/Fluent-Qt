# flow-view Specification

## Purpose

The system SHALL provide `view::collections::FlowView` as a Fluent collection view for model/delegate driven variable-size row-wrap item layouts while preserving `GridView` fixed-cell behavior.
