# calendar-date-picker Specification

## Purpose

The system SHALL provide `view::date_time::CalendarDatePicker` as a Fluent date entry control and `view::date_time::CalendarView` as its reusable calendar surface for standalone date selection and picker flyout composition.
