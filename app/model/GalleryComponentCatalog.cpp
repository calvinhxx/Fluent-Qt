...
const QVector<GalleryComponentCategory>& galleryComponentCatalog()
{
  static const QVector<GalleryComponentCategory> catalog{
      {QStringLiteral("basic-input"),
       ...
       {{QStringLiteral("button"), QStringLiteral("Button"),
        ...
        {QStringLiteral("compound-button"), QStringLiteral("CompoundButton"),
         Typography::Icons::Add},
        {QStringLiteral("checkbox"), QStringLiteral("CheckBox"),
         Typography::Icons::CheckMark},
        {QStringLiteral("color-picker"), QStringLiteral("ColorPicker"),
         Typography::Icons::Color},
        {QStringLiteral("combobox"), QStringLiteral("ComboBox"),
        ...
        {QStringLiteral("multi-select-combobox"),
         QStringLiteral("MultiSelectComboBox"), Typography::Icons::SelectAll},
        ...
        {QStringLiteral("toggle-split-button"),
         QStringLiteral("ToggleSplitButton"), Typography::Icons::ChevronDown},
      ...
      {QStringLiteral("collections"),
       ...
       {{QStringLiteral("data-grid"), QStringLiteral("DataGrid"),
         Typography::Icons::Grid},
        {QStringLiteral("drawer-view"), QStringLiteral("DrawerView"),
         Typography::Icons::List},
        {QStringLiteral("flip-view"), QStringLiteral("FlipView"),
         Typography::Icons::Forward},
        {QStringLiteral("flow-view"), QStringLiteral("FlowView"),
         Typography::Icons::Grid},
        {QStringLiteral("grid-view"), QStringLiteral("GridView"),
         Typography::Icons::Grid},
        {QStringLiteral("list-view"), QStringLiteral("ListView"),
         Typography::Icons::List},
        {QStringLiteral("split-view"), QStringLiteral("SplitView"),
         Typography::Icons::BackToWindow},
        {QStringLiteral("stack-view"), QStringLiteral("StackView"),
         Typography::Icons::AllApps},
        {QStringLiteral("tree-view"), QStringLiteral("TreeView"),
      ...
      {QStringLiteral("date-time"),
       ...
       {{QStringLiteral("calendar-date-picker"),
         QStringLiteral("CalendarDatePicker"), Typography::Icons::Calendar},
        {QStringLiteral("calendar-view"), QStringLiteral("CalendarView"),
         Typography::Icons::Calendar},
        {QStringLiteral("date-picker"), QStringLiteral("DatePicker"),
         Typography::Icons::Calendar},
        {QStringLiteral("time-picker"), QStringLiteral("TimePicker"),
      ...
      {QStringLiteral("dialogs-flyouts"),
       ...
       {{QStringLiteral("content-dialog"), QStringLiteral("ContentDialog"),
         Typography::Icons::Message},
        {QStringLiteral("dialog"), QStringLiteral("Dialog"),
         Typography::Icons::Message},
        {QStringLiteral("flyout"), QStringLiteral("Flyout"),
         Typography::Icons::Message},
        {QStringLiteral("popup"), QStringLiteral("Popup"),
         Typography::Icons::BackToWindow},
        {QStringLiteral("teaching-tip"), QStringLiteral("TeachingTip"),
         Typography::Icons::Info},
        {QStringLiteral("coach-mark"), QStringLiteral("CoachMark"),
         Typography::Icons::Info}}},
      {QStringLiteral("layout"),
       ...
       {{QStringLiteral("accordion"), QStringLiteral("Accordion"),
        ...
        {QStringLiteral("card"), QStringLiteral("Card"),
         Typography::Icons::BackToWindow},
        {QStringLiteral("divider"), QStringLiteral("Divider"),
         Typography::Icons::Hyphen},
        {QStringLiteral("expander"), QStringLiteral("Expander"),
         Typography::Icons::ChevronDown},
      ...
      {QStringLiteral("menus-toolbars"),
       ...
       {{QStringLiteral("menu"), QStringLiteral("Menu"),
         Typography::Icons::List, QStringLiteral("FluentMenu")},
        {QStringLiteral("menu-bar"), QStringLiteral("MenuBar"),
         Typography::Icons::Save, QStringLiteral("FluentMenuBar")},
        {QStringLiteral("command-bar"), QStringLiteral("CommandBar"),
         Typography::Icons::More},
        {QStringLiteral("command-bar-flyout"),
         QStringLiteral("CommandBarFlyout"), Typography::Icons::ChevronDown}}},
      {QStringLiteral("navigation"),
       ...
       {{QStringLiteral("breadcrumb"), QStringLiteral("Breadcrumb"),
        ...
        {QStringLiteral("navigation-view"), QStringLiteral("NavigationView"),
         Typography::Icons::GlobalNav},
        {QStringLiteral("pivot"), QStringLiteral("Pivot"),
         Typography::Icons::AllApps},
        {QStringLiteral("selector-bar"), QStringLiteral("SelectorBar"),
         Typography::Icons::SelectAll},
        {QStringLiteral("tab-view"), QStringLiteral("TabView"),
         Typography::Icons::AllApps}}},
      {QStringLiteral("scrolling"),
       ...
       {{QStringLiteral("annotated-scrollbar"),
         QStringLiteral("AnnotatedScrollBar"), Typography::Icons::List},
        {QStringLiteral("pips-pager"), QStringLiteral("PipsPager"),
         Typography::Icons::More},
        {QStringLiteral("scrollbar"), QStringLiteral("ScrollBar"),
         Typography::Icons::Down},
        {QStringLiteral("scroll-view"), QStringLiteral("ScrollView"),
         Typography::Icons::Down}}},
      {QStringLiteral("status-info"),
       QStringLiteral("Status & info"),
       QStringLiteral("status_info"),
       Typography::Icons::Info,
       {{QStringLiteral("avatar"), QStringLiteral("Avatar"),
         Typography::Icons::Contact},
        {QStringLiteral("info-badge"), QStringLiteral("InfoBadge"),
         Typography::Icons::Info},
        {QStringLiteral("info-bar"), QStringLiteral("InfoBar"),
         Typography::Icons::Info},
        {QStringLiteral("progress-bar"), QStringLiteral("ProgressBar"),
         Typography::Icons::Refresh},
        {QStringLiteral("progress-ring"), QStringLiteral("ProgressRing"),
         Typography::Icons::Refresh},
        {QStringLiteral("shimmer"), QStringLiteral("Shimmer"),
         Typography::Icons::Refresh},
        {QStringLiteral("toast"), QStringLiteral("Toast"),
         Typography::Icons::Message},
        {QStringLiteral("tooltip"), QStringLiteral("ToolTip"),
         Typography::Icons::Info}}},
      {QStringLiteral("text-fields"),
       ...
       {{QStringLiteral("auto-suggest-box"), QStringLiteral("AutoSuggestBox"),
        ...
        {QStringLiteral("line-edit"), QStringLiteral("LineEdit"),
         Typography::Icons::Edit},
        {QStringLiteral("number-box"), QStringLiteral("NumberBox"),
         Typography::Icons::Calculator},
        {QStringLiteral("password-box"), QStringLiteral("PasswordBox"),
         Typography::Icons::Lock},
        {QStringLiteral("text-edit"), QStringLiteral("TextEdit"),
         Typography::Icons::Edit}}},
      ...
      {QStringLiteral("foundation"),
       ...
       QStringLiteral("foundation"),
       Typography::Icons::Font,
       {{QStringLiteral("font-icon"), QStringLiteral("FontIcon"),
         Typography::Icons::Font, QString(), QStringLiteral("fluent")}}}};
  return catalog;
}
