...
# Load the cross-agent Skill

Read and follow
`../../../.agents/skills/build-fluentqt-gui/SKILL.md` completely. That file is
the repository's canonical Agent Skills implementation. Resolve its referenced
repository files from the FluentQt root and do not duplicate or replace its
workflow with Claude-specific instructions.
